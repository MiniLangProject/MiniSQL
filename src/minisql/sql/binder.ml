...
/// Performs the fail operation for the minisql sql binder module.
...
/// @param currentName currentName value consumed by this operation.
/// @param newLocalName newLocalName value consumed by this operation.
...
/// @param sources sources value consumed by this operation.
/// @param table table value consumed by this operation.
/// @param alias alias value consumed by this operation.
...
/// Returns the computed value or operation status.
/// Any side effects are limited to the explicitly invoked dependencies.
/// @param availableQueries availableQueries value consumed by this operation.
/// @param name Name of the affected item.
...
/// @param explicitNames explicitNames value consumed by this operation.
...
/// Any side effects are limited to the explicitly invoked dependencies.
/// @param sources sources value consumed by this operation.
/// @param named named value consumed by this operation.
/// @param alias alias value consumed by this operation.
...
/// Returns the computed value or operation status.
/// Any side effects are limited to the explicitly invoked dependencies.
/// @param currentType currentType value consumed by this operation.
/// @param hasConcrete hasConcrete value consumed by this operation.
/// @param nextExpression nextExpression value consumed by this operation.
...
/// @param expression expression value consumed by this operation.
/// @param sources sources value consumed by this operation.
/// @param allowAggregates allowAggregates value consumed by this operation.
/// @param database database value consumed by this operation.
...
/// Any side effects are limited to the explicitly invoked dependencies.
/// @param expression expression value consumed by this operation.
/// @param groups groups value consumed by this operation.
...
/// @param statement statement value consumed by this operation.
/// @param database database value consumed by this operation.
/// @param inheritedQueries inheritedQueries value consumed by this operation.
/// @param viewStack viewStack value consumed by this operation.
...
/// @param expression expression value consumed by this operation.
/// @param boundExpression boundExpression value consumed by this operation.
/// @param table table value consumed by this operation.
...
/// Performs the componentName operation for the minisql sql binder module.
/// Returns the computed value or operation status.
/// Any side effects are limited to the explicitly invoked dependencies.
...
/// Performs the targetMilestone operation for the minisql sql binder module.
/// Returns the computed value or operation status.
/// Any side effects are limited to the explicitly invoked dependencies.
...
/// Returns whether implemented satisfies the condition required by the minisql sql binder module.
/// Returns the computed value or operation status.
/// Does not modify its inputs.
