...
function keywordList()
  return [
    ...
    "SCHEMA", "SEQUENCE", "SHOW", "START", "STORED", "SUM", "TABLES", "TEXT", "THEN", "TRIGGER", "TRIM", "TRUNCATE", "TIME", "TIMESTAMP", "TO", "TRANSACTION", "TRUE", "UNION", "UNIQUE", "UPDATE", "UPPER",
...
function nonReservedIdentifierKeywordList()
  return [
    ...
    "MIN", "NEXTVAL", "CURRVAL", "NUMERIC", "POWER", "RANK", "PERCENT_RANK", "CUME_DIST", "NTILE", "LAG", "LEAD", "FIRST_VALUE", "LAST_VALUE", "NTH_VALUE", "REAL", "REPLACE", "ROUND", "ROW_NUMBER", "DENSE_RANK", "SMALLINT", "STRING_AGG", "SUBSTRING", "SUM", "TEXT", "TIME", "TRIM",
