...
/// Performs the fail operation for the minisql server database manager module.
...
/// Performs the bytesEqual operation for the minisql server database manager module.
...
/// @param path Path of the file or directory used by the operation.
/// @param expectedSize expectedSize value consumed by this operation.
/// @param operation operation value consumed by this operation.
...
/// Validates open for the minisql server database manager workflow.
/// Requires arguments that satisfy the validation performed below.
/// Returns the computed value or operation status.
/// Any side effects are limited to the explicitly invoked dependencies.
...
/// Performs I/O through its file, transport, or storage dependencies.
/// @param path Path of the file or directory used by the operation.
/// @param allowStandby allowStandby value consumed by this operation.
...
/// Opens open for the minisql server database manager module.
/// Returns the computed value or operation status.
/// Any side effects are limited to the explicitly invoked dependencies.
/// @param path Path of the file or directory used by the operation.
function open(path)
...
/// Creates create for the minisql server database manager module.
/// Returns the computed value or operation status.
/// Any side effects are limited to the explicitly invoked dependencies.
...
/// @param database database value consumed by this operation.
/// @param sessionId Identifier of session.
/// @param peerEndpoint peerEndpoint value consumed by this operation.
...
/// @param database database value consumed by this operation.
/// @param elapsedMs elapsedMs value consumed by this operation.
/// @param resultBytes resultBytes value consumed by this operation.
/// @param errorCode errorCode value consumed by this operation.
...
/// Closes close owned by the minisql server database manager module.
/// Requires arguments that satisfy the validation performed below.
/// Returns its result or propagates a structured error from validation or a dependency.
...
/// Performs the componentName operation for the minisql server database manager module.
/// Returns the computed value or operation status.
/// Any side effects are limited to the explicitly invoked dependencies.
...
/// Performs the targetMilestone operation for the minisql server database manager module.
/// Returns the computed value or operation status.
/// Any side effects are limited to the explicitly invoked dependencies.
...
/// Returns whether implemented satisfies the condition required by the minisql server database manager module.
/// Returns the computed value or operation status.
/// Does not modify its inputs.
