...
function check(actual, expected, label)
  if actual != expected then
    print "M15 module smoke mismatch: " + label + " expected=" + expected + " actual=" + actual
    return 1
  end if
  return 0
end function
...
function checkBool(actual, expected, label)
  if actual != expected then
    print "M15 module smoke mismatch: " + label
    return 1
  end if
  return 0
end function
...
function main(args)
  ...
  failures = failures + checkBool(m24_storage_btree.isImplemented(), true, "storage.btree implementation")
  ...
  failures = failures + checkBool(m34_catalog_schema_history.isImplemented(), true, "catalog.schema_history implementation")
  ...
  failures = failures + checkBool(m35_sql_token.isImplemented(), true, "sql.token implementation")
  ...
  failures = failures + checkBool(m36_sql_lexer.isImplemented(), true, "sql.lexer implementation")
  ...
  failures = failures + checkBool(m37_sql_ast.isImplemented(), true, "sql.ast implementation")
  ...
  failures = failures + checkBool(m38_sql_parser.isImplemented(), true, "sql.parser implementation")
  ...
  failures = failures + checkBool(m39_sql_binder.isImplemented(), true, "sql.binder implementation")
  ...
  failures = failures + checkBool(m40_sql_types.isImplemented(), true, "sql.types implementation")
  ...
  failures = failures + checkBool(m41_sql_values.isImplemented(), true, "sql.values implementation")
  ...
  failures = failures + checkBool(m42_sql_expressions.isImplemented(), true, "sql.expressions implementation")
  ...
  failures = failures + checkBool(m43_sql_dialect.isImplemented(), true, "sql.dialect implementation")
  ...
  failures = failures + checkBool(m49_executor_executor.isImplemented(), true, "executor.executor implementation")
  ...
  failures = failures + checkBool(m50_executor_scan.isImplemented(), true, "executor.scan implementation")
  ...
  failures = failures + checkBool(m51_executor_filter.isImplemented(), true, "executor.filter implementation")
  ...
  failures = failures + checkBool(m52_executor_projection.isImplemented(), true, "executor.projection implementation")
  ...
  failures = failures + checkBool(m56_executor_dml.isImplemented(), true, "executor.dml implementation")
  ...
  if failures != 0 then
    print "MiniSQL M15 module smoke test: FAIL (failures=" + failures + ")"
    return 1
  end if
  print "MiniSQL M15 module smoke test: SUCCESS (71 modules)"
  return 0
end function
