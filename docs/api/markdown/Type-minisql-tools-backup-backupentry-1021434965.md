# `minisql.tools.backup.BackupEntry`

[Home](README.md) · [Source file](File-src-minisql-tools-backup-ml-1706031693.md)

<a id="struct-struct-minisql-tools-backup-backupentry-struct-backupentry-src-minisql-tools-backup-ml-948769355"></a>
## BackupEntry
...
<a id="field-field-minisql-tools-backup-backupentry-checksum-checksum-src-minisql-tools-backup-ml-1438191905"></a>
### checksum
