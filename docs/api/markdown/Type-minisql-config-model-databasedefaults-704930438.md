# `minisql.config.model.DatabaseDefaults`

[Home](README.md) · [Source file](File-src-minisql-config-model-ml-1120384851.md)

<a id="struct-struct-minisql-config-model-databasedefaults-struct-databasedefaults-src-minisql-config-model-ml-640309479"></a>
## DatabaseDefaults
...
<a id="field-field-minisql-config-model-databasedefaults-checksumalgorithm-checksumalgorithm-src-minisql-config-model-ml-1043408214"></a>
### checksumAlgorithm
