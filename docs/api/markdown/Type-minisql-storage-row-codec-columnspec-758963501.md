# `minisql.storage.row_codec.ColumnSpec`

[Home](README.md) · [Source file](File-src-minisql-storage-row-codec-ml-756043630.md)

<a id="struct-struct-minisql-storage-row-codec-columnspec-struct-columnspec-src-minisql-storage-row-codec-ml-425703"></a>
## ColumnSpec
...
<a id="field-field-minisql-storage-row-codec-columnspec-maxlength-maxlength-src-minisql-storage-row-codec-ml-959396656"></a>
### maxLength
