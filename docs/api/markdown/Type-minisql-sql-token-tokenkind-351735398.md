# `minisql.sql.token.TokenKind`

[Home](README.md) · [Source file](File-src-minisql-sql-token-ml-1018094825.md)

<a id="enum-enum-minisql-sql-token-tokenkind-enum-tokenkind-src-minisql-sql-token-ml-164939489"></a>
## TokenKind
...
<a id="enum_variant-enum-variant-minisql-sql-token-tokenkind-comma-comma-6-src-minisql-sql-token-ml-707158406"></a>
### Comma
