# `minisql.config.model.SafetyConfig`

[Home](README.md) · [Source file](File-src-minisql-config-model-ml-1120384851.md)

<a id="struct-struct-minisql-config-model-safetyconfig-struct-safetyconfig-src-minisql-config-model-ml-216893111"></a>
## SafetyConfig
...
<a id="field-field-minisql-config-model-safetyconfig-allowremotewithoutauthentication-allowremotewithoutauthentication-src-minisql-config-model-ml-2044998455"></a>
