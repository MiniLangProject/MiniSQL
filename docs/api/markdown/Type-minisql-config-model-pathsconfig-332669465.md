# `minisql.config.model.PathsConfig`

[Home](README.md) · [Source file](File-src-minisql-config-model-ml-1120384851.md)

<a id="struct-struct-minisql-config-model-pathsconfig-struct-pathsconfig-src-minisql-config-model-ml-203706973"></a>
## PathsConfig
...
<a id="field-field-minisql-config-model-pathsconfig-dataroot-dataroot-src-minisql-config-model-ml-862272177"></a>
### dataRoot
