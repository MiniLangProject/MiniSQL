# `minisql.storage.row_codec.RowSchema`

[Home](README.md) · [Source file](File-src-minisql-storage-row-codec-ml-756043630.md)

<a id="struct-struct-minisql-storage-row-codec-rowschema-struct-rowschema-src-minisql-storage-row-codec-ml-363647719"></a>
## RowSchema
...
<a id="field-field-minisql-storage-row-codec-rowschema-columns-columns-src-minisql-storage-row-codec-ml-429021258"></a>
### columns
