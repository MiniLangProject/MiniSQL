# `minisql.storage.row_codec.RowData`

[Home](README.md) · [Source file](File-src-minisql-storage-row-codec-ml-756043630.md)

<a id="struct-struct-minisql-storage-row-codec-rowdata-struct-rowdata-src-minisql-storage-row-codec-ml-204429773"></a>
## RowData
...
<a id="field-field-minisql-storage-row-codec-rowdata-schemaversion-schemaversion-src-minisql-storage-row-codec-ml-1312527935"></a>
### schemaVersion
